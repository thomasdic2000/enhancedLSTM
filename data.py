...
def load_embeddings(embdding_path):
    ...
    #Filling embed matrix
    for idx, word in enumerate(model.index2word):
        embedding_matrix[idx + 1] = model[word]# word_embed_mat
    return embedding_matrix

def pad_sequences(sequences, maxlen=None, dtype='int32', padding='post',
                  truncating='post', value=0.):
    """ pad_sequences: padding sequences to be equal length
    Arguments:
        sequences:
        maxlen:
        dtype: 
        ...
        value: float 
    Returns:
        x: numpy array, dimension after padding: (number_of_sequences, maxlen)
    """
